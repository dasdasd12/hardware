...
static void sdram_video_send_config_help(void)
{
    ...
    sdram_usb_debug_write_line("ISOLATION base=686111a transport=v37_32k_dma2 readback=dma256 codec=stream64k playback=stage3_pair index=all_frames usb_link=fixed");
