...
完整项目文档放在 [`dasdasd12/Docs-For-AI-Keyboard`](https://github.com/dasdasd12/Docs-For-AI-Keyboard)。当前开发以 `firmware/`、`hw_tests/`、`basic/`、本 README 和关联文档仓库为准。暂时不维护 `docs/` 下的旧方案；如果后续需要引用其中内容，应先按当前原理图、LaTeX、芯片手册和已有固件重新核对。
