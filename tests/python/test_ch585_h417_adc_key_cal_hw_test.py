...
H417_V5F_H = os.path.join(ROOT, "hw_tests", "h417", "cases", "v5f_rtthread", "include", "v5f_hw_test.h")
H417_V5F_TEST = os.path.join(ROOT, "hw_tests", "h417", "cases", "v5f_rtthread", "src", "v5f_hw_test.c")
