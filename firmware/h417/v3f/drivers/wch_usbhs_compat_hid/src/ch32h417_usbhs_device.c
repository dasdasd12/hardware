...
__attribute__((weak)) void ch32h417_usbhs_hid_nkro_on_in_complete(void)
{
}

__attribute__((weak)) void ch32h417_usbhs_hid_nkro_on_bus_reset(void)
{
}
...
void USBHS_IRQHandler(void)
{
    ...
    else if(intflag & USBHS_UDIF_BUS_RST)
    {
        ...
        ch32h417_usbhs_hid_nkro_on_bus_reset();
