...
#define DEF_USBD_DEVICE_DESC_LEN     ((uint8_t)USBFS_MyDevDescr[0])
#define DEF_USBD_CONFIG_DESC_LEN     ((uint16_t)MyCfgDescr[2] + (uint16_t)(MyCfgDescr[3] << 8))
#define DEF_USBD_REPORT_DESC_LEN     126
#define DEF_USBD_LANG_DESC_LEN       ((uint16_t)USBFS_MyLangDescr[0])
#define DEF_USBD_MANU_DESC_LEN       ((uint16_t)USBFS_MyManuInfo[0])
#define DEF_USBD_PROD_DESC_LEN       ((uint16_t)USBFS_MyProdInfo[0])
#define DEF_USBD_SN_DESC_LEN         ((uint16_t)USBFS_MySerNumInfo[0])

/******************************************************************************/
/* external variables */
extern const uint8_t USBFS_MyDevDescr[];
extern const uint8_t MyCfgDescr[];
extern const uint8_t USBFS_MyLangDescr[];
