 ...
 *
 * Build from hardware/firmware:
 *   gcc -std=gnu99 -Wall -Wextra -Werror \
 *       -I tests/host_stubs -I common -I h417/v3f/applications \
 *       tests/host_ch585_link_test.c \
 *       h417/v3f/applications/ch585_link.c \
 *       -o build/host_ch585_link_test
 */
