...
```powershell
make APP=spi_slave_test DEFS_EXTRA="-DCH585_ADC_PROBE_MODE=1 -DCH585_ADC_PROBE_RIGHT_HALF=0"
```
...
```powershell
cd F:\嵌赛\hardware\firmware\ch585
make clean
make APP=spi_slave_test DEFS_EXTRA="-DCH585_ADC_PROBE_MODE=1"
```
...
cd F:\嵌赛\hardware\firmware\ch585
make clean
make APP=spi_slave_test DEFS_EXTRA="-DCH585_ADC_PROBE_MODE=1 -DCH585_ADC_PROBE_UART_MODE=1"
```
...
```powershell
make clean
make APP=spi_slave_test DEFS_EXTRA="-DCH585_ADC_PROBE_MODE=1 -DCH585_ADC_PROBE_UART_MODE=1 -DCH585_ADC_PROBE_UART_PORT=0"
```
...
```powershell
make clean
make APP=spi_slave_test DEFS_EXTRA="-DCH585_ADC_PROBE_MODE=1 -DCH585_ADC_PROBE_UART_MODE=1 -DCH585_ADC_PROBE_UART_PORT=0 -DCH585_ADC_PROBE_UART0_REMAP=1"
```
...
```powershell
make clean
make APP=spi_slave_test DEFS_EXTRA="-DCH585_ADC_PROBE_MODE=1 -DCH585_ADC_PROBE_DEBUG_KEY=0xFF"
```
...
cd F:\嵌赛\hardware\firmware\ch585
make clean
make APP=spi_slave_test DEFS_EXTRA="-DCH585_ADC_PROBE_MODE=1 -DCH585_ADC_PROBE_UART_MODE=1 -DCH585_ADC_PROBE_DEBUG_KEY=0xFF -DCH585_ADC_PROBE_UART_EVENT_MODE=1"
```
