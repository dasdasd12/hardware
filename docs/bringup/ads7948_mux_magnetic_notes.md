...
3. CH585 测试工程里的临时按下判断:
   - `firmware/ch585/spi_slave_test/src/main.c`
...
1. `firmware/ch585/frontend/ads7948.h`
2. `firmware/ch585/frontend/ads7948.c`
...
3. `firmware/ch585/frontend/ch585_ads7948_mux_scan.h`
4. `firmware/ch585/frontend/ch585_ads7948_mux_scan.c`
...
5. `firmware/ch585/common/magnetic_key_engine.h`
6. `firmware/ch585/common/magnetic_key_engine.c`
...
因此，本文件里原本提到的 `firmware/ch585/common/magnetic_key_engine.*` 应定位为：
